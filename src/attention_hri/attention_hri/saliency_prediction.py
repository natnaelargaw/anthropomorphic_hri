...
from attention_hri.saliency_model import *
...
class saliency_prediction(Node):
  ...
  def __init__(self):
    ...
    self.m.load_weights('src/attention_hri/attention_hri/ivsp.h5') # please change this relative path according to your finle orgnization
    self.queue = deque()
